...
const CustomizeProducts = ({
    ...
    const [selectdVariant, setSelectedVariant] = useState<products.Variant>();
    ...
    return (
        <div className="flex flex-col gap-6">
                        ...
                        {option.choices?.map((choice) => {
                            ...
                            return option.name === "Color" ? (
                                <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 relative" style={{
                                    ...
                                    cursor: disabled ? "bot-allowed" : "pointer",
                                }}
                                ...
                                <li className="ring-1 ring-lama text-lama rounded-md py-1 px-4 text-sm"
                                    style={{
                                        ...
                                        boxShadow: disabled ? "none" : "0px 0px 0px 1px #f35c7a"
                                    }}
                                    onClick={clickHandler}
                                >
                                    {choice.description}
            ...
            <Add 
                productId={productId} 
                variantId={selectdVariant?._id || "00000000-0000-0000-0000-000000000000"} 
                stockNumber={selectdVariant?.stock?.quantity || 0} />
